...
function Form() {
  ...
  const stripeWidth = `${progress}%`;
  const minStripeWidth = "40px";
      ...
      <ThemeProvider theme={theme}>
        ...
        {showForm && (
          <Box
            ...
            sx={{
              backgroundColor: "rgb(4, 69, 175, 0.3)",
              overflow: "hidden",
            }}
          >
            <Box
              ...
              sx={{
                backgroundColor: "rgb(4, 69, 175)",
                maskImage: `linear-gradient(to right, blue ${minStripeWidth}, white ${stripeWidth}, transparent ${stripeWidth})`,
                transition: "width 1200ms ease-in-out", // Transition with a duration of 600ms
              }}
            ></Box>
          </Box>
        )}        
                ...
                >
                  ...
                  >
                    ...
                    {questions[currentQuestion][1] === "rating" && (
                      <Box border={0}
                        sx={{
                          fontSize: "13.5px", color: "rgb(4,95,167)", marginLeft: "5px", marginBottom: "1px", marginTop: "-5px",
