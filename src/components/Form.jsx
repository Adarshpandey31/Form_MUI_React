...
function Form() {
  ...
  const questions = [
    ["1.) Enter your name*", "input"],
    ["2.) Enter your brand name*", "input"],
    ["3.) How satisfied are you with the overall experience of working with upcred.ai*", "rating"],
    ["4.) Did upcred.ai team effectively understand and address your brand's goals and objectives?*", "tick"],
    ["5.) How well did our team communicate and collaborate with your brand throughout the campaign?*", "rating"],
    ["6.) Were the deliverables and content produced by upcred.ai in line with your expectations and brand guidelines?*", "tick"],
    ["7.) Did the campaign generate the desired results and meet your marketing objectives?*", "tick"],
    ["8.) How likely are you to recommend upcred.ai to other brands based on your experience?*", "rating"],
    ["9.) Would you consider partnering with upcred.ai again for future campaigns?*", "tick"],
  ];
